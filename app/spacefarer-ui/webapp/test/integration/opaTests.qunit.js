...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "spacefarerui/test/integration/FirstJourney",
    "spacefarerui/test/integration/SpacefarersListJourney",
    "spacefarerui/test/integration/SpacefarersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
